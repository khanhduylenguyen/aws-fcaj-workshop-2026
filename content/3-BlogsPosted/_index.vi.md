...
### [Blog 1 - Tự động hóa "thay máu" AWS Storage Gateway từ AL2 sang AL2023 bằng IaC](3.1-Blog1/)
...
### [Blog 2 - Tự động hóa số hóa bệnh án với Amazon Bedrock Data Automation và AWS HealthLake](3.2-Blog2/)
...
### [Blog 3 - Kinh nghiệm thực chiến: Giải bài toán đọc hợp đồng tự động với Doczy.ai™ trên AWS](3.3-Blog3/)
